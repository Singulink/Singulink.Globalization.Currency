...
public class ToSortedMoneyBag
{
    ...
    {
        var bag = Values.ToSortedMoneyBag(NewRegistry);
    ...
    public class Tests<TBag> where TBag : IReadOnlyMoneyBag
    {
        ...
        {
            var bag = Bag.ToSortedMoneyBag(CurrencyRegistry.Default);
