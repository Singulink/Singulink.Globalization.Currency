...
[PrefixTestClass]
public class ToImmutableMoneyBag
{
    ...
    {
        var bag = Values.ToImmutableMoneyBag(NewRegistry);
    ...
    public class Tests<TBag> where TBag : IReadOnlyMoneyBag
    {
        ...
        {
            var bag = Bag.ToImmutableMoneyBag();
            bag.Registry.ShouldBeSameAs(NewRegistry);
            bag.ShouldBe(Values, ignoreOrder: true);
        }
        ...
        {
            var bag = Bag.ToImmutableMoneyBag(CurrencyRegistry.Default);
