...
public sealed partial class ImmutableSortedMoneySet : IImmutableMoneySet
{
    ...
    public ImmutableSortedMoneySet RemoveAll(IEnumerable<Currency> currencies)
    {
        ...
        return builder is not null ? new ImmutableSortedMoneySet(_registry, builder.ToImmutable()) : this;
    }
    ...
    public ImmutableSortedMoneySet TrimZeroAmounts()
    {
        ...
        return builder is null ? this : new ImmutableSortedMoneySet(_registry, builder.ToImmutable());
    }
    ...
    private ImmutableSortedMoneySet AddInternal(decimal amount, Currency currency)
    {
        ...
        return amountLookup is null ? this : new ImmutableSortedMoneySet(_registry, amountLookup);
    }
