...
public sealed partial class MoneyBag : IMoneyBag
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="MoneyBag"/> class with the <see cref="CurrencyRegistry.Default"/> currency registry.
    /// </summary>
    public MoneyBag() : this(CurrencyRegistry.Default) { }

    /// <summary>
    /// Initializes a new instance of the <see cref="MoneyBag"/> class with the specified currency registry.
    /// </summary>
    ...
    public MoneyBag(IEnumerable<MonetaryValue> values) : this(CurrencyRegistry.Default, values) { }
    ...
    /// <inheritdoc cref="MoneyBag(ReadOnlySpan{MonetaryValue})"/>
    public MoneyBag(params MonetaryValue[] values) : this(CurrencyRegistry.Default, values) { }

    /// <inheritdoc cref="MoneyBag(CurrencyRegistry, ReadOnlySpan{MonetaryValue})"/>
    public MoneyBag(CurrencyRegistry registry, params MonetaryValue[] values) : this(registry, values.AsSpan()) { }

    /// <summary>
    /// Initializes a new instance of the <see cref="MoneyBag"/> class with the <see cref="CurrencyRegistry.Default"/> currency registry and adds all
    /// the specified values.
    /// </summary>
    /// <exception cref="ArgumentException">
    /// Attempted to add a value with a currency that is not available in the currency registry.
    /// </exception>
    public MoneyBag(ReadOnlySpan<MonetaryValue> values) : this(CurrencyRegistry.Default, values) { }

    /// <summary>
    /// Initializes a new instance of the <see cref="MoneyBag"/> class with the specified currency registry and adds all the specified values.
    /// </summary>
    /// <exception cref="ArgumentException">
    /// Attempted to add a value with a currency that is not available in the currency registry.
    /// </exception>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="MoneyBag"/> class. Trusted internal constructor.
    /// </summary>
    internal MoneyBag(CurrencyRegistry registry, IEnumerable<MonetaryValue> values, bool ensureValuesInRegistry) : this(registry)
    {
    ...
    /// <inheritdoc/>
    static IReadOnlyMoneyBag IReadOnlyMoneyBag.Create(CurrencyRegistry registry, IEnumerable<MonetaryValue> values) => new MoneyBag(registry, values);

    /// <inheritdoc/>
    static IMoneyBag IMoneyBag.Create(CurrencyRegistry registry, IEnumerable<MonetaryValue> values) => new MoneyBag(registry, values);
    ...
    /// <summary>
    /// Enumerates the elements of a <see cref="MoneyBag"/>.
    /// </summary>
