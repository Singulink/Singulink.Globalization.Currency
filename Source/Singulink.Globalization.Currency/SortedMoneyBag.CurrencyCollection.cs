...
/// <content>
/// Contains the <see cref="CurrencyCollection"/> implementation for <see cref="SortedMoneyBag"/>.
/// </content>
partial class SortedMoneyBag
{
    /// <summary>
    /// Represents a collection of currencies in a <see cref="SortedMoneyBag"/>.
    /// </summary>
    public sealed partial class CurrencyCollection : ICollection<Currency>, IReadOnlyCollection<Currency>
    {
        private readonly SortedMoneyBag _bag;

        internal CurrencyCollection(SortedMoneyBag bag)
        {
            _bag = bag;
        }
        ...
        public struct Enumerator : IEnumerator<Currency>
        {
            ...
            internal Enumerator(SortedMoneyBag bag)
            {
