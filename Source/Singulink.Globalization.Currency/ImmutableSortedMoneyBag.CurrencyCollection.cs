...
/// <content>
/// Contains the <see cref="CurrencyCollection"/> implementation for <see cref="ImmutableSortedMoneyBag"/>.
/// </content>
partial class ImmutableSortedMoneyBag
{
    /// <summary>
    /// Represents a collection of currencies in a <see cref="ImmutableSortedMoneyBag"/>.
    /// </summary>
    public sealed partial class CurrencyCollection : ICollection<Currency>, IReadOnlyCollection<Currency>
    {
        private readonly ImmutableSortedMoneyBag _bag;

        internal CurrencyCollection(ImmutableSortedMoneyBag bag)
        {
            _bag = bag;
        }
        ...
        public struct Enumerator : IEnumerator<Currency>
        {
            ...
            internal Enumerator(ImmutableSortedMoneyBag bag)
            {
