...
/// <content>
/// Contains the <see cref="CurrencyCollection"/> implementation for <see cref="MoneySet"/>.
/// </content>
partial class MoneySet
{
    /// <summary>
    /// Represents a collection of currencies in a <see cref="MoneySet"/>.
    /// </summary>
    public sealed class CurrencyCollection : ICollection<Currency>, IReadOnlyCollection<Currency>
    {
        private readonly MoneySet _set;

        internal CurrencyCollection(MoneySet set)
        {
            _set = set;
        }
        ...
        public struct Enumerator : IEnumerator<Currency>
        {
            ...
            internal Enumerator(MoneySet set)
            {
