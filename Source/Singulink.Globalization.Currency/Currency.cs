...
public class Currency : IFormattable
{
    ...
    /// <summary>
    /// Gets the three letter ISO currency code for built-in currencies, or whatever currency code was assigned for custom currencies.
    /// </summary>
    ...
    /// <summary>
    /// Gets the name of this currency. Returns the English name for built-in system currencies.
    /// </summary>
    ...
    /// <summary>
    /// Gets the currency associated with the specified currency code from the default system registry.
    /// </summary>
    ...
    public static bool TryGet(string currencyCode, [MaybeNullWhen(false)] out Currency currency) => SystemCurrencies.TryGetCurrency(currencyCode, out currency);

    /// <summary>
    /// Gets the currency associated with the specified currency code from the default system registry.
    /// </summary>
    /// <param name="currencyCode">The currency code of the currency to get.</param>
    public static Currency Get(string currencyCode) => SystemCurrencies[currencyCode];
    ...
    internal static CurrencyRegistry CreateDefaultSystemRegistry()
    {
        ...
        foreach (var culture in CultureInfo.GetCultures(CultureTypes.SpecificCultures))
        {
            ...
            {
                currency = new Currency(region.CurrencyEnglishName, region.ISOCurrencySymbol, region.CurrencySymbol, culture.NumberFormat.CurrencyDecimalDigits);
